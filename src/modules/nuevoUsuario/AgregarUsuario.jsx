                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex justify-between space-x-7">
                                        ...
                                        <label for="rol" className="font-bold">{formLabelTitle.label2}</label>
                                            <select required className=" w-full h-8 pl-2 rounded-md input-border" name="rol" >
                                        ...
                                        <div className="w-1/3">
                                            ...
                                            <select required className="w-full h-8 pl-2 rounded-md input-border" name="estado" placeholder="Selecciona una opción">
                                                <option type="String" value="">Selecciona una opción</option>
