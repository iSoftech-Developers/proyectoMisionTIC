    ...
    return (
        ...
        <>
            <div className= "flex justify-between space-x-5 mt-6 h-28 mb-9">
                <div className="bg-green-500 w-full flex items-center rounded-2xl">
                ...
                <div className=" bg-yellow-400 w-full flex items-center rounded-2xl">
                ...
                <div className="bg-blue-700 w-full flex items-center rounded-2xl">
                ...
                <div className="bg-purple-800 w-full flex items-center rounded-2xl">
