    ...
    return (
        ...
        <>
            <div className= "flex justify-between space-x-5 mt-6 h-28 mb-9">
                <div className="bg-green-500 w-full flex items-center rounded-lg">
                ...
                <div className="bg-blue-900 w-full flex items-center rounded-lg">
                ...
                <div className=" bg-green-900 w-full flex items-center rounded-lg">
                ...
                <div className="bg-purple-900 w-full flex items-center rounded-lg">
                ...
                <div className="bg-pink-900 w-full flex items-center rounded-lg">
