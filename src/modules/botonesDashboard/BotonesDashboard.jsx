...
const BotonesDashboard = () => {
    return (
        ...
        <>
            <div className= "hidden md:grid lg:col-auto space-x-5 mt-6 mb-9">
                <div className="block md:flex md:w-full md:gap-4 lg:flex lg:w-full lg:gap-4 lg:justify-between">
                    ...
                    <div className="bg-purple-800 w-full flex items-center rounded-lg">
