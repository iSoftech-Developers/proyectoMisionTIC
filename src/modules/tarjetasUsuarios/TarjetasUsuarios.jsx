    ...
    return (
        <>
            <div className="flex flex-col">
                <div className="mt-6 ">
                    <div className="flex">
                        <button class="tablinks px-3 text-gray-400 hover:text-gray-800 hover:bg-gray-200 text-2xl font-bold">Administrador de Usuarios</button>
                        <button class="tablinks px-3 text-gray-400 hover:text-gray-800 hover:bg-gray-200 text-2xl font-bold">Solicitudes Pendientes</button>
                    </div>
                </div>
