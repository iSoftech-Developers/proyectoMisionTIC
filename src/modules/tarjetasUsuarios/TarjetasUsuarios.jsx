...
const TarjetasUsuarios = ({variableCards,userCardInfo}) => {
    ...
    const ConsultaUsuarios = ({consulta})=>{
        console.log("estoy adentro yuju",consulta)
        ...
        <div className="ml-2 w-1/4 mt-6">
            <label for="userole"></label>
                <select
                 ...
                 required className="pl-2 w-full h-8 input-border text-gray-500" name="roleoptions">
