            ...
            <form ref={form} onSubmit={submitForm} className=" space-y-8 my-16">
                <div className="form-upper-section flex justify-between font-bold label-color">
                    <div className="w-1/5">
                        ...
                        <input required class=" w-full h-8 p-2 input-border" type="String" name="nombrecliente"/>
                    </div>
                    <div className="w-1/5">
                ...
                <div className=" w-full flex justify-center">
                    <input className="w-1/6 cursor-pointer bg-green-400 h-10 rounded String-white font-bold my-16" type="submit" value="Guardar"/>
