...
const NuevaVenta=()=>{
    ...
    Object.keys(nuevaVenta).forEach((k) => {
      ...
      console.log('lista vehiculos', datosVenta);
        ...
        <div>
            <form ref={form} onSubmit={submitForm} className=" space-y-8 my-16">
                ...
                <div className="form-lower-section flex justify-between font-bold label-color">
                    ...
                    <div className="w-1/6">
                        <input required className="cursor-pointer w-full mt-4 h-10 rounded text-white bg-gray-400" type="button" name="userspecial" id="userspecial" value="Productos"/>
                    </div>
                </div>
